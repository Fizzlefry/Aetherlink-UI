...
MODEL_DRIFT_SCORE = Gauge(
    "lead_model_drift_score", "Feature drift score (std deviations from training)"
)
...
def predict(
    ...
    try:
        ...
        z = intercept + sum(f * c for f, c in zip(features, coeffs, strict=False))
