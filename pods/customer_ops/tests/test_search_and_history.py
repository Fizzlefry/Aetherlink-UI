...
def test_search_leads_by_keyword():
    ...
    client.post(
        "/v1/lead",
        json={"name": "Alice", "phone": "555-1001", "details": "metal roof installation"},
    )
    client.post(
        "/v1/lead", json={"name": "Bob", "phone": "555-1002", "details": "solar panel quote"}
    )
    client.post(
        "/v1/lead", json={"name": "Charlie", "phone": "555-1003", "details": "metal siding repair"}
    )
...
def test_histogram_metric_recorded():
    ...
    resp = client.post(
        ...
        json={
            "name": "MetricTest",
            "phone": "555-9999",
            "details": "urgent metal roof repair needed",
        },
    )
