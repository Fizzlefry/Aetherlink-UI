...
def get_conn(db_path: str = "data/knowledge.duckdb", embedding_dim: Optional[int] = None) -> duckdb.DuckDBPyConnection:
    """
    ...
    try:
        ...
        if tenant_id is None:
            ...
            result = conn.execute(f"""
                ...
                ORDER BY distance
                LIMIT ?;
            """, [query_vec, tenant_id, top_k]).fetchall()
...
def bump_api_key_counters(key: str) -> tuple[bool, Optional[str]]:
    """
