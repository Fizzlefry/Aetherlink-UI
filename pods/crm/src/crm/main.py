...
from crm.db import engine, Base
...
app = FastAPI(
    title="PeakPro CRM",
    description="Minimal CRM for testing monitoring stack",
    version="1.0.0"
)
    ...
    while True:
        try:
            ...
            try:
                ...
                proposals = db.query(Lead).filter(
                    Lead.qbo_invoice_id.isnot(None)
                ).all()
