...
from .auth_models import Org, User, Role, UserRole, Permission
from .models_v2 import Lead, Opportunity, Job
...
def seed_database():
    ...
    try:
        ...
        ops_role = Role(
            org_id=demo_org.id,
            name="Operations",
            description="Job and crew management"
        )
        ...
        leads_data = [
            {
                "name": "Smith Residence", "email": "john.smith@email.com", "phone": "555-0100",
                "company": "Smith Family", "source": "web", "status": "new",
                "score": 75, "heat_level": "hot",
                "notes": "Needs roof replacement after storm damage"
            },
            {
                "name": "Johnson Commercial", "email": "mary@johnson.biz", "phone": "555-0200",
                "company": "Johnson Enterprises", "source": "referral", "status": "contacted",
                "score": 60, "heat_level": "warm",
                "notes": "Commercial building, 20k sq ft flat roof"
            },
            {
                "name": "Brown Townhomes", "email": "info@browntownhomes.com", "phone": "555-0300",
                "company": "Brown Property Management", "source": "api", "status": "qualified",
                "score": 85, "heat_level": "hot",
        ...
        print(f"   📧 Admin login: admin@peakpro.io / admin123")
