...
from .metrics import CRM_EMAILS_SENT, CRM_PORTAL_APPROVALS, CRM_PORTAL_VIEWS
...
def get_proposal(proposal_id: int, db: Session = Depends(get_db), user=Depends(get_current_user)):
    """
