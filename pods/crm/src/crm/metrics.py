...
CRM_EMAILS_SENT = Counter("crm_emails_sent_total", "Emails sent by type", ["type"])
...
CRM_PORTAL_APPROVALS = Counter("crm_portal_approvals_total", "Approvals")
...
CRM_INVOICES_PAID = Counter(
    "crm_invoices_paid_total", "Invoices transitioned to Paid via polling", ["org_id"]
)
