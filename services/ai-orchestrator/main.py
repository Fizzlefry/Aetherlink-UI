...
PROVIDER_URLS = {
    "claude": os.getenv("PROVIDER_CLAUDE_URL", "http://aether-ai-summarizer:9108/summaries/extract-lead"),
...
provider_health: Dict[str, Dict[str, Any]] = {
    name: {"healthy": True, "last_error": None, "last_checked": None, "total_calls": 0, "failed_calls": 0}
